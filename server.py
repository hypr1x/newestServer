...
BOX = imgui.get_color_u32_rgba(1, 0, 0, 1)
SNAP = imgui.get_color_u32_rgba(1, 0, 0, 1)
...
IGN = imgui.get_color_u32_rgba(1, 0, 0, 1)
IGN2 = imgui.get_color_u32_rgba(0, 1, 0, 1)
    ...
    while not glfw.window_should_close(window):
        ...
        for player in POS:
            try:
                ...
                # dl.add_line(headboxX, headboxY,  1920/2, 1080/2, SNAP, 2)
                ...
                with imgui.font(verdanab):
                    ...
                    if int(float(player[15][1])) == 0:
                        draw_smooth_outlined_text(headboxX - (text_size[0]/2), headboxY - (text_size[1]/2), distance)
                        dl.add_text(headboxX - (text_size[0]/2), headboxY - (text_size[1]/2), IGN, distance)
                        ...
                        draw_smooth_outlined_text(headboxX - (text_size[0]/2), headboxY - (text_size[1]/2), distance)
                        dl.add_text(headboxX - (text_size[0]/2), headboxY - (text_size[1]/2), IGN2, distance)
                        draw_smooth_outlined_text(headboxX - (text_size2[0]/2), x + text_size2[1]/2, name)
